            ...
            if (update.Message is { Text: { } messageTextt })
            {
                if (messageText == "Юр. послуги")
                {
                    ...
                    var legalServicesText = "<b>Юридические услуги</b>\n" +
                                            "<i>1. Договори, контракти: розробка договорів, контрактів, зокрема ЗЕД, угод, оцінка ризиків, коригування, підготовка протоколів розбіжностей,\r\nпогодження/переговори з контрагентом щодо\r\nправок.\r\nУ процесі ведення господарської діяльності будь-якого підприємства виникають правовідносини з контрагентами, у звʼязку з чим виникає необхідність укладання різного роду договорів, а саме:\r\n• купівлі-продажу\r\nоренди, суборенди\r\nпостачання\r\nна надання послуг, виконання робіт\r\nЗЕД-контрактів\r\nдодаткових угод про зміну умов договору. продовження терміну договору тощо.\r\nОцінка ризиків - аналіз умов договорів щодо відповідності нормам законодавства та інтересів сторони, виявлення несприятливих умов, які можуть спричинити у себе розбіжності з контрагентом у майбутньому.\r\nКоригування та підготовка протоколів розбіжностей,\r\nпогодження/переговори з контрагентом щодо правок -\r\nкомплекс послуг із внесення змін та правок до договорів відповідно до ваших побажань та інтересів, подальше складання протоколу зі змінами та їх обговорення з контрагентом.\n2. Підготовка листів, скарг, відповідей у державні органи, органи місцевого самоврядування, підприємства та організації.\r\nЦей блок охоплює надання юридичних послуг у процесі комунікації з державними органами, органами місцевого самоврядування, підприємствами та організаціями, та передбачає такі послуги:\r\n﻿﻿листи, скарги, відповіді на адресу правоохоронних, податкових органів, прокуратури, інших контролюючих державних органів, банківських установ тощо;\r\n﻿﻿підготовка різного роду листів контрагентам про оплату товару або послуги, відстрочення оплати, допостачання товару, неможливість поставки або виконання зобовʼязань за договором та інших листів\r\n3. Розробка внутрішніх документів підприємства: накази, розпорядження, інструкції, становища; протоколи/рішення загальних зборів учасників/\r\nвищого органу (для ТОВ, ТДВ, ПП)\r\nЧітка та злагоджена робота підприємства багато в чому залежить від наявності коректно прописаних внутрішніх документів, тому ми надаємо послуги з розробки досить великого спектру внутрішніх документів підприємства:\r\n﻿﻿накази:\r\n﻿﻿розпорядження;\r\n﻿﻿інструкції;\r\n﻿﻿становища;\r\n﻿﻿протоколи/рішення загальних зборів учасників/ вищого органу про зміну директора, про зміну складу учасників підприємства, про доповнення або зміну переліку видів діяльності, про зміну розташування</i>\n" +
